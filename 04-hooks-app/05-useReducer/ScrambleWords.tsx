...
export const ScrambleWords = () => {
  ...
  //   const [scrambleWord, setScrambleWord] = useState(scrambleWord(currentWord));
  ...
  const handleGuessSubmit = (e: React.FormEvent) => {
    ...
    //   setScrambledWor(scrambleWord(newWords[0]));
    //   return;
    // }
  ...
  const handleSkip = () => {
    ...
    // setScrambleWord(scrambleWord(updatedWords[0]));
    // setGuess("");
  };
  ...
  const handlePlayAgain = () => {
    ...
    // setIsGameOver(false);
    // setSkipCounter(0);
    // setScrambleWord(scrambleWord(newArray[0]));
  };
